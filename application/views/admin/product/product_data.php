                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?= base_url('Product/viewAddProduct')?>">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $rowProduct->currency ?></td>
                                        <td>
                                            <a href="<?=base_url('Product/viewEditProduct/'.$rowProduct->productCode )?>">
                                                <button class="btn btn-sm btn-warning" id="btn-edit">Edit</button>
                                            </a>
                                            <button class="btn btn-sm btn-danger" id="btn-delete" value="<?=$rowProduct->productCode?>">Hapus</button>
                                        </td>
                                    </tr>
